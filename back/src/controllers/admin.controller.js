...
const Gallary = require("../models/gallary.model.js")
...
const addGallary = async (req, res) => {
    try {
        ...
        const gallaryImgLocalPath = req.file?.path
        if (
        ...
        const gallaryImg = await uploadOnCloudinary(gallaryImgLocalPath)
        ...
        const category = await Gallary.create({ caption, gallary: gallaryImg.url })
        ...
        return res
            .json(
                {
                    success: true,
                    message: "Gallary post Successfully",
                }
            )
...
// For showing all Gallary
const showGallary = async (req, res) => {
    try {
...
module.exports = { register, login, logout, getcurrentAdmin, update, passwordChange, postCategory, deleteCategory, showCategory, updateCategory, addGallary, showGallary }