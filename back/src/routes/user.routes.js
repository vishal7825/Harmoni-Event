...
const { booking, getBooking ,showallBookings, deleteBooking } = require("../controllers/booking.controller.js");
const router = Router();
...
router.route("/deleteBooking").delete(verifyJWT, upload.none(), deleteBooking);
